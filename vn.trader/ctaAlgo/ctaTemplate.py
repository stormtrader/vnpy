...
class order_ret_code:
    CANCEL_ORDER_LIMIT = 1 #到达订单的上限数目
...
class CtaTemplate(object):
    ...
    # 今日总撤单数目，如果超过了一定数目，那么不给进行撤单（暂时先这么粗暴吧）
    cancel_limit = 100
    cancel_num = 0
    ...
    def cancelOrder(self, vtOrderID):
        ...
        if STOPORDERPREFIX in vtOrderID:
            ...
            if self.cancel_num >= self.cancel_limit:
                return order_ret_code.CANCEL_ORDER_LIMIT
